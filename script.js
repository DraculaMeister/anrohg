...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loginBtn) {
        loginBtn.addEventListener('click', () => {
            const DISCORD_CLIENT_ID = '1519360762941018223';
            
            const REDIRECT_URI = encodeURIComponent(window.location.origin + '/menu.html');
            
            const OAUTH_URL = `https://discord.com/oauth2/authorize?client_id=1519360762941018223&response_type=code&redirect_uri=https%3A%2F%2Fanrohg.vercel.app%2F&scope=identify+guilds+guilds.members.read`;
